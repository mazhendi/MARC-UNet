...
from models.RCA_module import BA_module_resnet
...
class InceptionA(torch.nn.Module):
    def __init__(self, in_channels):
        ...
        self.branch_pool = torch.nn.Conv2d(in_channels, 960, kernel_size=1)
...
#=========================================================================================
class MARCU_Net(nn.Module):
    def __init__(self, img_ch=3, output_ch=1):
        super(MARCU_Net, self).__init__()
