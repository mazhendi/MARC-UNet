...
if __name__ == "__main__":
    #------------Path of the dataset -------------------------
    data_root_path = 'E:\\code\\VesselSeg-Pytorch-master\\prepare_dataset\\data_path_list\\DRIVE'
    ...
    gt_train = "training/1st_manual/"
    fov_train = "training/mask/"
    #test
    img_test = "test/images/"
    gt_test = "test/1st_manual/"
    fov_test = "test/mask/"
    #----------------------------------------------------------
    save_path = "E:\code\VesselSeg-Pytorch-master\prepare_dataset\data_path_list\DRIVE"
