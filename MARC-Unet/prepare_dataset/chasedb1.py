...
if __name__ == "__main__":
    #------------Path of the dataset --------------------------------
    data_root_path = 'E:\\code\\VesselSeg-Pytorch-master\\prepare_dataset\\data_path_list\\CHASEDB1'
    ...
    fov = "mask"
    #---------------save path-----------------------------------------
    save_path = "E:\\code\\VesselSeg-Pytorch-master\\prepare_dataset\\data_path_list\\CHASEDB1"
